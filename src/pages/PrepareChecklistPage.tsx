    ...
    try {
      ...
      try {
        await dbService.addAuditLog({
          ...
          details: {
            page: 'PrepareChecklistPage',
            regulationSummaryUsedLength: regulationSummary.length,
            originalChecklistLength: existingChecklist.length,
            updatedChecklistLength: newChecklist.length,
          }
        });
      } catch (logError) {
        console.warn("Failed to write audit log for checklist update:", logError);
      }
    } catch (e: any) {
