...
const CreateReportPage: React.FC = () => {
  ...
  const handleGenerateReport = async () => {
    ...
    try {
      ...
      // Also, extract a summary for the email page (could be a separate Gemini call or simple extraction)
      // For now, let's use a portion of the report or ask Gemini for a concise list
    ...
    <div className="space-y-6">
      ...
      {safetyReport && (
        <div className="p-6 bg-white rounded-lg shadow">
          ...
          {/* <MarkdownRenderer content={safetyReport} /> */}
           <TextArea
            id="safetyReportArea"
            value={safetyReport}
